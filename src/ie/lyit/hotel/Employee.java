...
public class Employee extends Person implements Payable {
	private Date dob; // Employee has a name, address & phoneNumber from Person
	private Date startDate; // AND a dob, startdate, salary & number
	...
	public Employee(String t, String fN, String sn, String address, String phoneNo, int d, int m, int y, Date startDate,
			double salary) {
