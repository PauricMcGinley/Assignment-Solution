...
public class EmployeeTester {
	...
	public static void main(String[] args) {
		// Create an Employee object called employeeA
		...
		Employee employeeB = new Employee("Ms", "Lisa", "Simpson", "155 Stateside,NYC", "086 0987653", 20, 12, 1992,
				new Date(1, 2, 2009), 25000);
		...
		employees.add(new Employee("Mrs", "Marge", "Simpson", "155 Stateside,NYC", "086 9876543", 12, 10, 1954,
				new Date(1, 1, 1990), 80000));
		employees.add(new Employee("Mr", "Bart", "Simpson", "155 Stateside,NYC", "086 1234567", 5, 3, 1988,
				new Date(4, 8, 2010), 20000));
